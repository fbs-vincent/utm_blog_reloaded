<div class="blog__sidebar">
            <div class="blog__sidebar__profile">
              <div class="blog__sidebar__profile__img">
                <img src="http://localhost/utm_blog_reloaded/wp-content/uploads/2021/11/bob.jpg" alt="" />
              </div>
            ...
            <div class="blog__sidebar__categories">
              ...
              <ul>
                <li>
                  <a href="<?php echo site_url('/category/spiritual'); ?>"
                    >spiritual
                    <svg
                      height="20"
                      aria-hidden="true"
                ...
                <li>
                  <a href="<?php echo site_url('/category/grown-up-abc-book'); ?>"
                    >grow-up abc books
                    <svg
                      height="20"
                      aria-hidden="true"
                ...
                <li>
                  <a href="<?php echo site_url('/category/social-enterprise'); ?>"
                    >social enterprise
                    <svg
                      height="20"
                      aria-hidden="true"
                ...
                <li>
                  <a href="<?php echo site_url('/category/movie'); ?>"
                    >movie
                    <svg
                      height="20"
                      aria-hidden="true"
                ...
                <li>
                  <a href="<?php echo site_url('/category/book-speaker-conference'); ?>"
